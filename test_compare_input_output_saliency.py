...
#   print("Check Fisher Info")
  for k in convolution_list:
     fisher_caffe[k] = named_modules[k].blobs[named_modules[k].saliency_pos_].data[0]
...
#   print("Check 1st order Taylor")
  for k in convolution_list:
     taylor_caffe[k] = named_modules[k].blobs[named_modules[k].saliency_pos_].data[0]
...
#   print("Check Hessian Diag")
  for k in convolution_list:
     hessian_diag_caffe[k] = named_modules[k].blobs[named_modules[k].saliency_pos_].data[0]
...
#   print("Check Hessian Diag Approx 2")
  for k in convolution_list:
     hessian_diag_approx2_caffe[k] = named_modules[k].blobs[named_modules[k].saliency_pos_].data[0]
...
#   print("Check Taylor 2nd")
  for k in convolution_list:
     taylor_2nd_caffe[k] = named_modules[k].blobs[named_modules[k].saliency_pos_].data[0]
...
#   print("Check Taylor 2nd Approx2")
  for k in convolution_list:
     taylor_2nd_approx2_caffe[k] = named_modules[k].blobs[named_modules[k].saliency_pos_].data[0]
...
print("Check 1st order Taylor")
for k in convolution_list:
   taylor_caffe[k] = named_modules[k].blobs[named_modules[k].saliency_pos_].data[1]
...
print("Check Hessian Diag")
for k in convolution_list:
   hessian_diag_caffe[k] = named_modules[k].blobs[named_modules[k].saliency_pos_].data[2]
...
print("Check Hessian Diag Approx 2")
for k in convolution_list:
   hessian_diag_approx2_caffe[k] = named_modules[k].blobs[named_modules[k].saliency_pos_].data[3]
...
print("Check Taylor 2nd")
for k in convolution_list:
   taylor_2nd_caffe[k] = named_modules[k].blobs[named_modules[k].saliency_pos_].data[4]
...
print("Check Taylor 2nd Approx2")
for k in convolution_list:
   taylor_2nd_approx2_caffe[k] = named_modules[k].blobs[named_modules[k].saliency_pos_].data[5]
