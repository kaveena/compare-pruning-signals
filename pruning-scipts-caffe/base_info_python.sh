...
for (( i=1; i<=$iterations; i++ ))
  ...
  do
    for saliency_method in $saliency_python
    do
      ...
      do
        ...
        do
          ...
          norm_lower=${norm,,}
          filename=$filename_prefix$input_lower-$saliency_method_lower-$norm_lower\_norm-$scaling\_python_iter$i.npy
          skip=false
          ...
          then 
            filename=$filename_prefix$input_lower-$saliency_method_lower-$norm_lower\_norm-$scaling\_skip_input_channels\_skip_output_channels\_python_iter$i.npy
          elif [[ $skip_input_channels == true ]] && [[ $skip_output_channels == false ]]
          then 
            filename=$filename_prefix$input_lower-$saliency_method_lower-$norm_lower\_norm-$scaling\_skip_input_channels\_python_iter$i.npy
          elif [[ $skip_input_channels == false ]] && [[ $skip_output_channels == true ]]
          then 
            filename=$filename_prefix$input_lower-$saliency_method_lower-$norm_lower\_norm-$scaling\_skip_output_channels\_python_iter$i.npy
          fi
          ...
          then
            ...
            then
              ...
              then
                GLOG_minloglevel=1 python compare_pruning_techniques_input_channels_python.py \
                \--filename $filename \
                \--arch $arch \
                \--dataset $dataset \
                ...
                GLOG_minloglevel=1 python compare_pruning_techniques_python.py \
                \--filename $filename \
                \--arch $arch \
                \--dataset $dataset \
                \--stop-acc $use_stop_acc \
