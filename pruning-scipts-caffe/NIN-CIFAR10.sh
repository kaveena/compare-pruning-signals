...
prune WEIGHT AVERAGE_INPUT L1 l2_normalisation
# best activations
prune ACTIVATION AVERAGE_INPUT L2 l2_normalisation
prune ACTIVATION AVERAGE_INPUT L2 l1_normalisation
# best gradients
prune ACTIVATION TAYLOR_2ND_APPROX2 SQR_SUM weights_removed
prune ACTIVATION TAYLOR_2ND_APPROX1 SQR_SUM weights_removed
